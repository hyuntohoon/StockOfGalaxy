...
public class NewsServiceImpl implements NewsService {
    ...
    @Override
    public ResponseEntity<List<TodayNewsResponseDTO>> getTodayNews(LocalDate date) {
        List<TodayNewsResponseDTO> newsList = new ArrayList<>();
        newsList.add(TodayNewsResponseDTO.builder()
            .id(1L)
            .title("React 18 출시")
